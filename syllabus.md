...
# CS 1632
Software Quality Assurance - Spring 2026
...
**Class GitHub repo:** https://www.github.com/wonsunahn/CS1632_Spring2026
...
This lecture will use a **[flipped
...
As such, this class is organized around 10 in-class exercises, one exercise per
week.  For this to work, it is important that you view the pre-recorded
lectures posted on Canvas Panopto that prepare you for each exercise.  It is
your responsibility to keep up with the lectures by following the
[Schedule](schedule.md).  There will be TopHat questions asked in class each
week before the exercise to check that you are following.
...
* **Supplementary Exercises 1-4:** Supplementary exercises that are not linked to a deliverable
...
developers need to deliver to stakeholders at predetermined dates.  Whilst
exercises are done individually, deliverables are done in groups of two.  By
the time the group starts on the deliverable, each member would have done the
corresponding exercise (and would have received GradeScope feedback too, either
autograder feedback, or instructor feedback, or both).  Each member should
reflect upon the feedback and make sure the same mistakes are not made on the
deliverable again.  If any of the feedback does not make sense, please do not
hesitate to ask your instructor.  Please do not discuss your solutions or share
your code outside your group --- you have the exercises for that purpose.  Here
are the 5 deliverables:
...
Since you will be working closely with your partner throughout the semester,
please sit next to your partner once groups are formed at the beginning of the
semester.  You are encouraged to talk to your partner when you do the in-class
exercises so that you make sure you are both on the same page.  The earlier and
more frequent the communication, the smoother your group work will be.  If you
are done with the in-class exercise early (which is expected for some
exercises) then start planning on the next deliverable with your partner and
get started on it.
...
Teams communication.  You are strongly encouraged to find and work with a
partner.  However, I understand that some students have life situations that
disallow them from synchronizing regularly with a partner.  If you feel that
you cannot live up to the expectations of group work, then yes, you are allowed
to work alone.
...
I would like to stress that group work is not necessarily less work --- it is a
different type of work.  You should be spending as much time communicating and
planning as you would have otherwise spent coding.  In the process, hopefully
you can learn how to collaborate and perhaps come to enjoy working together.
...
2. Out-of-class
   ...
   Please use Microsoft Teams to post the question or comment on the relevant
channel.  As the semester progresses, each exercise or deliverable that you
work on will gain its own channel.  Please ask all exercise or deliverable
related questions there.  This way, the entire classroom can benefit from your
question or comment.  Please do not be shy --- if you have a questions, chances
are that there are ten more classmates with the same question who will be
thanking you.  And sometimes one of your classmates has a better answer than
the instructor (has happened on more than one occasion).

   You can also send a private message to your instructor using the Teams chat
feature.  You can send a chat message if posting the question involves sharing
your work for a deliverable, which is of course disallowed.  You can also send
a chat message if the discussion is not going to benefit the rest of the class
and you want to have a private conversation.  In all other cases, I will likely
ask you to post the same question on the relevant channel before answering.
Let me stress once more that you are encouraged to share your work for the
exercises for discussion purposes as stated earlier, just not the deliverables.

   Whether you post or chat with me, if you are asking a code related question,
please submit the version of the code in question to GradeScope before asking.
That way, your instructor can reproduce your bug and give you a faster more
accurate answer.  Please understand that it is impossible to reproduce a bug
with a screenshot (for those of you who habitually post screenshots of your
code when asking questions --- it is an unpleasant habit that will not make you
friends in the workplace).  Often the bug isn't even in the screenshot and is
hiding somewhere else.

3. Email / Canvas messages

   Please use Teams for all communications.  By using Teams chat instead of
email, all previous conversations are on the same window so it is much easier
to keep track of context.  Also, often I will be able to respond immediately on
Teams an carry on a real time conversation.  Teams even allows us to transition
to video calls or screen-sharing if needed.  Windows version of Teams even
allows me to gain control over your laptop temporarily so that I can fix
problems for you!

Please install Teams on all your devices so that you get real time
notifications and we can carry on real time conversations as the need arises.
